...
def clone(amount,papa):
    for baby in range(amount):
        ...
        if Risk[len(Turtle)-1]/500>1: b=1
        else: b=Risk[len(Turtle)-1]/500
        newborn.color(r,g,b)
...
def setUp(amount):
    ...
    for baby in range(amount):
        ...
        FOOD.append(0)
        ENERGY.append(900)
        if Speed[len(Turtle)-1]/30>1: r=1
        else: r=Speed[len(Turtle)-1]/30
        if Radius[len(Turtle)-1]/120>1: g=1
        else: g=Radius[len(Turtle)-1]/120
        if Risk[len(Turtle)-1]/500>1: b=1
        else: b=Risk[len(Turtle)-1]/500
        newborn.color(r,g,b)
        newborn.turtlesize(Size[len(Turtle)-1]/13)
