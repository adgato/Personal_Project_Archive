...
public class Vector3 {
	...
	public Vector3 refractIn(Vector3 N, double eta) {
		double Ndot = N.dot(this);
		double tir = 1 - eta * eta * (1 - Ndot * Ndot);
		if (tir < 0)
			return new Vector3(0); //total internal reflection is very cool, but i don't think i need it
		return N.scale(eta * Ndot - Math.sqrt(tir)).subtract(this.scale(eta));
	}
