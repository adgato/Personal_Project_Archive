namespace UnityEngine.Rendering.CustomRenderPipeline
{
    public static class ShaderPassTag
    {
        ...
        public static ShaderTagId example = new ShaderTagId("ExampleLightModeTag");
        public static ShaderTagId shadowFront = new ShaderTagId("ShadowFront");
        public static ShaderTagId shadowBack = new ShaderTagId("ShadowBack");
        public static ShaderTagId shadowWrite = new ShaderTagId("ShadowWrite");
        public static ShaderTagId mirrorMark = new ShaderTagId("MirrorMark");
        public static ShaderTagId mirrorBack = new ShaderTagId("MirrorBack");
    }
    ...
    public static class ShaderBindings
    {
        ...
        /// <summary>
        /// Should run: <code><see cref="ScriptableRenderContext.SetupCameraProperties(Camera, bool)"/></code> Before this
        /// </summary>
        public static void SetPerCameraShaderVariables(ScriptableRenderContext context, Camera camera)
        {
            ...
            Vector4[] shaderFrustumPlanes = new Vector4[6];
            for (int i = 0; i < 6; i++)
            {
                Plane plane = frustumPlanes[i];
                shaderFrustumPlanes[i] = new Vector4(plane.normal.x, plane.normal.y, plane.normal.z, plane.distance);
            }
            cmd.SetGlobalVectorArray(ShaderBindings.cameraWorldClipPlanes, shaderFrustumPlanes);
            ...
            cmd.SetGlobalMatrix(ShaderBindings.matrixIP, invProjectionMatrix);
